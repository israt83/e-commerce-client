...
//   return (
    // <div className="container mx-auto py-28 flex flex-col md:flex-row justify-center items-center  space-x-10">
    //   <div className="">
...
const handleEditReview = (rev) => {
  ...
  reviews.map((rev, idx) => (
    ...
    >
      ...
      {/* Edit & Delete Button (only if logged-in user is owner) */}
